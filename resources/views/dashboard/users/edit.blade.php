            ...
            <div class="card-body" style="margin-top:10px">
                <div class="box-form">
                    <form id="form" class="dash-user-form-edit" name="dash-user-form-edit" id="dash-user-form-edit" style="min-width: 320px; width:600px">
                        ...
                        <div class="form-group">
                            <label>CPF</label>
                            <input type="text" class="form-control input-form-user" name="cpf" id="cpf" value="{{$user->cpf}}" maxlength="14" required>
                        </div>
                        <div class="form-group">
                            <label>Telefone</label>
                            <input type="tel" mask="(99)9 9999-9999" class="form-control input-form-user" name="phone" id="phone" value="{{$user->phone}}" maxlength="21" required>
                        </div>
                        <div class="form-group">
